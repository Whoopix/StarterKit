...
<div class="col-lg-12 col-md-12 col-xlg-12 col-xs-12" style="margin-bottom:50px;">
                                <div class="ribbon-wrapper card">
                                    <div class="ribbon ribbon-info">SEO</div>
                                ...
                                <label for="inputName1" class="control-label"><?=$lang["seo_title"];?></label>
		 ...
		 <div class="form-group">
                                 <label for="inputName1" class="control-label"><?=$lang["seo_link"];?></label>
		 ...
		 <div class="form-group">
                                  <label for="inputName1" class="control-label"><?=$lang["seo_keywords"];?></label>
								<br>
								<input type="text" name="seo[<?=$lang_id;?>][keywords]" value="<?=htmlspecialchars($value["keywords"]);?>" data-role="tagsinput" placeholder="<?=$lang["seo_keywords"];?>" />
								<div class="help-block with-errors"><ul class="list-unstyled"><li></li></ul></div>
          </div>
