                ...
                <div class="col-full">
                    <div class="row">
                        <nav class="woocommerce-breadcrumb">
                            ...
                            </span><a href=",products,<?=$gccc['id']; ?>"><?=$gccc['title']; ?></a>
                            <span class="delimiter">
                                <i class="tm tm-breadcrumbs-arrow-right"></i>
                            </span><% PAGE_TITLE %>
                        </nav>
                        ...
                        <div id="primary" class="content-area">
                                    ...
                                    <div class="single-product-wrapper">
                                        ...
                                        <div class="summary entry-summary">
                                            ...
                                            <div class="single-product-meta">
												...
												<span class="sku_wrapper">מספר קטלוגי
                                                ...
                                                <div class="product-actions">
                                                    ...
                                                    <form enctype="multipart/form-data" method="post" class="cart">
                                                        <div class="quantity">
                                                            ...
                                                            <input type="number" size="4" class="input-text qty text" title="Qty" value="1" name="quantity" id="qty_<?=$gpq['page_id'];?>">
                                                        </div>
                                                        <!-- .quantity -->
                                                    ...
                                                    <!-- .cart -->
                                                    <a class="add-to-compare-link" href="compare.html">הוסף לרשימת השוואה</a>
                                                </div>
                                                <!-- .product-actions -->
                                            </div>
						 ...
						 <div class="woocommerce-tabs wc-tabs-wrapper">
                                        ...
                                        <div class="tab-content">
											...
											//
											$get_cat_products = mysql_query("SELECT * FROM mod_products_list AS mpl INNER JOIN mod_products AS mp ON mpl.id = mp.page_id WHERE mpl.cat_id = '".$gccc['page_id']."' LIMIT 4")or die(mysql_error());
											...
											?>
                                                                ...
                                                                <div class="product">
                                                                    <a class="woocommerce-LoopProduct-link woocommerce-loop-product__link" href=",products,show_<?=$gcp['id'];?>">
