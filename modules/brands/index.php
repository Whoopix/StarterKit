...
$Get_Product = mysql_query("SELECT * FROM mod_brands_list AS mpcl INNER JOIN mod_brands AS mpc ON mpcl.id = mpc.page_id WHERE mpcl.id = '".$get_id."'")or die(mysql_error());
$GP = mysql_fetch_array($Get_Product);

$TEMP_PAGE_TITLE  = $GP['title'];
$TEMP_INPAGE_TITLE = $GP['title'];
$TEMP_TEMPLATE = 4;
...
function PAGE_TEXT() {
	...
	$get_some = mysql_query("SELECT * FROM mod_brands_list WHERE id = '".$get_id."'");
							   ...
							   <div class="shop-archive-header">
                                    <div class="jumbotron" style="background-position:center center;background-size:cover;background-image:url('files/upload/<?=$gsssssss->pic;?>');">
                                        ...
                                        <div class="jumbotron-caption">
                                            <h3 class="jumbo-title" style="font-size:40px;font-weight:bold;"><% PAGE_TITLE %></h3>
								...
								/// תצורת ריבועים
													...
													$get_main_subs = mysql_query("SELECT * FROM mod_brands_list WHERE parent = '".$get_id."'");
								...
								?>
								 ...
								 <div class="shop-control-bar">
                                    ...
                                    <h1 class="woocommerce-products-header__title page-title">מוצרים בקטגוריה</h1>
                                    ...
                                    <form method="get" class="woocommerce-ordering">
                                        <select class="orderby" name="orderby" onchange="if (this.value) window.location.href=this.value">
                                            <option value="/,brands,<?=$get_id;?>?order=rating">סדר לפי פופולריות</option>
                                            <option value="/,brands,<?=$get_id;?>?order=priceUp">סדר לפי מחיר עולה</option>
                                            <option selected="/,brands,<?=$get_id;?>?order=priceDown" value="3">סדר לפי מחיר יורד</option>
                                            <option value="/,brands,<?=$get_id;?>?order=date">סדר לפי תאריך הוספה</option>
                                        ...
                                        <div class="woocommerce columns-5">
                                            <div class="products">
                                                ...
                                                <div class="product<?if($i % 1 == 0){?> first<?}?><?if($i % 5 == 0){?> last<?}?>">
                                                    ...
                                                    <a class="woocommerce-LoopProduct-link woocommerce-loop-product__link" href=",products,show_<?=$gpX['page_id'];?>">
     ...
     <div id="secondary" class="widget-area shop-sidebar" role="complementary">
                            ...
                            <div id="techmarket_products_filter-3" class="widget widget_techmarket_products_filter">
                                <span class="gamma widget-title">סינונים בקטגוריה</span>
								  ...
								  <form action=",brands,<?=$get_id?>" method="GET">
                                ...
                                <div class="widget woocommerce widget_price_filter" id="woocommerce_price_filter-2" style="text-align:center;">
                                    <p>
                                        ...
                                        <div class="price_slider_amount">
                                            <input id="amount" type="text" placeholder="Min price" data-min="6" value="33" name="from" style="display: none;">
                                ...
                                <div class="widget woocommerce widget_layered_nav maxlist-more" id="woocommerce_layered_nav-2">
									...
									while($gb = mysql_fetch_array($get_brands)){
										...
										$count = mysql_query("SELECT * FROM mod_products_list AS mbl INNER JOIN mod_products AS mb ON mbl.id = mb.page_id WHERE mbl.brand_id = '".$gb['page_id']."' AND mb.lang_id = '1'");
							  ...
							  <button class="button" style="width:100%;" type="submit">סנן מוצרים</button> 
                                ...
                                <ul class="product-categories ">
                                    <li class="product_cat">
										...
										$get_categories = mysql_query("SELECT * FROM mod_brands_list AS mpcl INNER JOIN mod_brands AS mpc ON mpcl.id = mpc.page_id WHERE mpcl.parent = '0' ORDER BY mpcl.order ASC");	
										...
										?>
                                            ...
                                            <li class="cat-item">
                                                <a style="font-weight:bold!important;font-size:14px;<? if($get_id == $gc['page_id']){echo "color:red;";} ?>" href=",brands,<?=$gc['page_id']; ?>">
                                               <b><?=$gc['title']; ?></b></a>
                                           </li>
											...
											if($gc['page_id'] == $GP['parent']){
													...
													$get_subs = mysql_query("SELECT * FROM mod_brands_list AS mpcl INNER JOIN mod_brands AS mpc ON mpcl.id = mpc.page_id 
													...
													<li class="cat-item">
														<a style="<? if($get_id == $gs['page_id']){echo "color:red;";} ?>" href=",brands,<?=$gs['page_id']; ?>">
