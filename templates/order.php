...
<script>
  ...
  <body class="page home page-template-default woocommerce-checkout woocommerce-page woocommerce-order-received can-uppercase woocommerce-active">
		...
		<script type="text/javascript" src="https://<?=$_SERVER['SERVER_NAME'];?>/js/website/sec.js"></script>
